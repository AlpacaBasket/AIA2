...
(def lexicon
  '{assassin {:cat noun, :sem (isa ?x assassin)}
    target   {:cat noun, :sem (isa ?x target)}
    guard    {:cat noun, :sem (isa ?x guard)}
    house    {:cat noun, :sem (isa ?x house)}
	weapon   {:cat noun, :sem (isa ?x weapon)}
    ...
    kill    {:cat verb1, :arity 1, :sem kill}
	pick-up {:cat verb1, :arity 1, :sem pick-up}
	grab    {:cat verb1, :arity 1, :sem grab}
	move    {:cat verb1, :arity 1, :sem move}
    })
